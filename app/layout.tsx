  ...
  return (
    <html lang="en" className="dark" style={{ colorScheme: "dark" }}>
      ...
      >
        ...
        <div className="fixed top-0 left-1/4 -translate-x-1/2 w-[500px] h-[500px] bg-white/5 rounded-full blur-[140px] pointer-events-none z-0 animate-pulse-slow" />
        <div className="fixed bottom-0 right-1/4 translate-x-1/2 w-[600px] h-[600px] bg-white/5 rounded-full blur-[160px] pointer-events-none z-0" />
